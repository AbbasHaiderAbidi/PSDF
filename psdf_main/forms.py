...
class UserForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'utilname' : forms.TextInput(attrs={'placeholder':'Name of Utility','class':'form-control col-md-12 mb-3 text-center', 'id':'utility'}),
            ...
            'email' : forms.EmailInput(attrs={'id':'email', 'class':'form-control text-center mb-3 col-md-8', 'placeholder':'Enter e-mail','style':'height:100%;'})
        }
